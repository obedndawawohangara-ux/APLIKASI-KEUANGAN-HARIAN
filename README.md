...
3.	Menampilkan total pemasukan, total pengeluaran, dan saldo secara otomatis. 
4.	Menampilkan daftar transaksi dalam bentuk tabel. 
5.	Edit dan hapus data transaksi. 
6.	Penyimpanan data menggunakan Local Storage. 
7.	Export data transaksi ke file keuangan.txt dalam format tabel.
...
2.	Data transaksi dapat disimpan dan ditampilkan pada tabel. 
3.	Fitur edit dan hapus data berfungsi dengan baik. 
4.	Total pemasukan, total pengeluaran, dan saldo dihitung secara otomatis. 
5.	Data tersimpan menggunakan Local Storage sehingga tetap tersedia saat aplikasi dibuka kembali. 
